...
fruits_with_more_than_five_characters = [i for i in fruits if len(i) > 5]
print(fruits_with_more_than_five_characters)

# Exercise 6 - make a list that contains each fruit with exactly 5 characters

fruits_with_only_five_characters = [i for i in fruits if len(i) == 5]
print(fruits_with_only_five_characters)

# Exercise 7 - Make a list that contains fruits that have less than 5 characters

fruits_with_less_than_five_characters = [i for i in fruits if len(i) < 5]
print(fruits_with_more_than_five_characters)
